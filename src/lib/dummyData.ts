import { Bet, BetStatus } from './contracts/BettingContract'
...
export const dummyBets: Bet[] = [
  {
    ...
    deadline: BigInt(Math.floor(Date.now() / 1000) + 86400 * 30), // 30 days from now
  ...
  },
  {
    ...
    deadline: BigInt(Math.floor(Date.now() / 1000) + 86400 * 180), // 6 months from now
  ...
  },
  {
    ...
    deadline: BigInt(Math.floor(Date.now() / 1000) - 86400), // 1 day ago (expired)
  ...
  },
  {
    ...
    deadline: BigInt(Math.floor(Date.now() / 1000) + 86400 * 120), // 4 months from now
    status: BetStatus.OPEN,
    winner: '0x0000000000000000000000000000000000000000',
  },
  {
    ...
    deadline: BigInt(Math.floor(Date.now() / 1000) + 86400 * 90), // 3 months from now
    status: BetStatus.MATCHED,
    winner: '0x0000000000000000000000000000000000000000',
  },
  {
    ...
    deadline: BigInt(Math.floor(Date.now() / 1000) + 86400 * 365 * 5), // 5 years from now
    status: BetStatus.OPEN,
    winner: '0x0000000000000000000000000000000000000000',
  },
  {
    ...
    deadline: BigInt(Math.floor(Date.now() / 1000) + 86400 * 365), // 1 year from now
    status: BetStatus.RESOLVED,
  ...
  },
  {
    ...
    deadline: BigInt(Math.floor(Date.now() / 1000) + 86400 * 365 * 2), // 2 years from now
    status: BetStatus.OPEN,
    winner: '0x0000000000000000000000000000000000000000',
  }
]
