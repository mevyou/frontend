  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#121214' }}>
      ...
      <div className="flex items-center gap-4 select-none">
        <span className="text-[88px] md:text-[140px] font-extrabold leading-none" style={{ color: 'white' }}>4</span>
        <div className="relative w-[88px] h-[88px] md:w-[220px] md:h-[220px] bottom-10 rounded-full overflow-hidden">
