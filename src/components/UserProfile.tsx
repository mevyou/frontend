  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-card border border-border rounded-xl p-6 mb-8 shadow-sm">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-2xl font-bold text-card-foreground mb-2">Your Profile</h1>
            <div className="flex items-center gap-2 mb-2">
              <span className="text-muted-foreground">Address:</span>
              <span className="text-card-foreground font-mono">{formatAddress(address)}</span>
              <button
                onClick={copyAddress}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-card border border-border rounded-xl p-4 shadow-sm">
          <div className="text-muted-foreground text-sm mb-1">Total Winnings</div>
